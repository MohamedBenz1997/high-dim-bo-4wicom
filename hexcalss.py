    ...
    def call(self):
        ...
        if self.UAVs_highway:
            ...
            if self.GUEs_debug:
                ...
                fixed_x01 = tf.random.uniform([2*self.batch_num, 1, 1], -866.0254-110.0, -866.0254-110.0)
                fixed_y01 = tf.random.uniform([2 * self.batch_num, 1, 1], -500.0, -500.0)
                fixed_z01 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser01 = tf.concat([fixed_x01, fixed_y01, fixed_z01], axis=2)
                fixed_x02 = tf.random.uniform([2*self.batch_num, 1, 1], -866.0254+55.0, -866.0254+55.0)
                fixed_y02 = tf.random.uniform([2 * self.batch_num, 1, 1], -500.0+95.26, -500.0+95.26)
                fixed_z02 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser02 = tf.concat([fixed_x02, fixed_y02, fixed_z02], axis=2)
                fixed_x03 = tf.random.uniform([2*self.batch_num, 1, 1], -866.0254+55.0, -866.0254+55.0)
                fixed_y03 = tf.random.uniform([2 * self.batch_num, 1, 1], -500.0-95.26, -500.0-95.26)
                ...
                fixed_x11 = tf.random.uniform([2*self.batch_num, 1, 1], -866.0254-110.0, -866.0254-110.0)
                fixed_y11 = tf.random.uniform([2 * self.batch_num, 1, 1], 0.0, 0.0)
                fixed_z11 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser11 = tf.concat([fixed_x11, fixed_y11, fixed_z11], axis=2)
                fixed_x12 = tf.random.uniform([2*self.batch_num, 1, 1], -866.0254+55.0, -866.0254+55.0)
                fixed_y12 = tf.random.uniform([2 * self.batch_num, 1, 1], 0.0+95.26, 0.0+95.26)
                fixed_z12 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser12 = tf.concat([fixed_x12, fixed_y12, fixed_z12], axis=2)
                fixed_x13 = tf.random.uniform([2*self.batch_num, 1, 1], -866.0254+55.0, -866.0254+55.0)
                fixed_y13 = tf.random.uniform([2 * self.batch_num, 1, 1], 0.0-95.26, 0.0-95.26)
                ...
                fixed_x21 = tf.random.uniform([2*self.batch_num, 1, 1], -866.0254-110.0, -866.0254-110.0)
                fixed_y21 = tf.random.uniform([2 * self.batch_num, 1, 1], 500.0, 500.0)
                fixed_z21 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser21 = tf.concat([fixed_x21, fixed_y21, fixed_z21], axis=2)
                fixed_x22 = tf.random.uniform([2*self.batch_num, 1, 1], -866.0254+55.0, -866.0254+55.0)
                fixed_y22 = tf.random.uniform([2 * self.batch_num, 1, 1], 500.0+95.26, 500.0+95.26)
                fixed_z22 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser22 = tf.concat([fixed_x22, fixed_y22, fixed_z22], axis=2)
                fixed_x23 = tf.random.uniform([2*self.batch_num, 1, 1], -866.0254+55.0, -866.0254+55.0)
                fixed_y23 = tf.random.uniform([2 * self.batch_num, 1, 1], 500.0-95.26, 500.0-95.26)
                ...
                fixed_x31 = tf.random.uniform([2*self.batch_num, 1, 1], -433.0127-110.0, -433.0127-110.0)
                fixed_y31 = tf.random.uniform([2 * self.batch_num, 1, 1], -750.0, -750.0)
                fixed_z31 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser31 = tf.concat([fixed_x31, fixed_y31, fixed_z31], axis=2)
                fixed_x32 = tf.random.uniform([2*self.batch_num, 1, 1], -433.0127+55.0, -433.0127+55.0)
                fixed_y32 = tf.random.uniform([2 * self.batch_num, 1, 1], -750.0+95.26, -750.0+95.26)
                fixed_z32 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser32 = tf.concat([fixed_x32, fixed_y32, fixed_z32], axis=2)
                fixed_x33 = tf.random.uniform([2*self.batch_num, 1, 1], -433.0127+55.0, -433.0127+55.0)
                fixed_y33 = tf.random.uniform([2 * self.batch_num, 1, 1], -750.0-95.26, -750.0-95.26)
                ...
                fixed_x41 = tf.random.uniform([2*self.batch_num, 1, 1], -433.0127-110.0, -433.0127-110.0)
                fixed_y41 = tf.random.uniform([2 * self.batch_num, 1, 1], -250.0, -250.0)
                fixed_z41 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser41 = tf.concat([fixed_x41, fixed_y41, fixed_z41], axis=2)
                fixed_x42 = tf.random.uniform([2*self.batch_num, 1, 1], -433.0127+55.0, -433.0127+55.0)
                fixed_y42 = tf.random.uniform([2 * self.batch_num, 1, 1], -250.0+95.26, -250.0+95.26)
                fixed_z42 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser42 = tf.concat([fixed_x42, fixed_y42, fixed_z42], axis=2)
                fixed_x43 = tf.random.uniform([2*self.batch_num, 1, 1], -433.0127+55.0, -433.0127+55.0)
                fixed_y43 = tf.random.uniform([2 * self.batch_num, 1, 1], -250.0-95.26, -250.0-95.26)
                ...
                fixed_x51 = tf.random.uniform([2*self.batch_num, 1, 1], -433.0127-110.0, -433.0127-110.0)
                fixed_y51 = tf.random.uniform([2 * self.batch_num, 1, 1], 250.0, 250.0)
                fixed_z51 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser51 = tf.concat([fixed_x51, fixed_y51, fixed_z51], axis=2)
                fixed_x52 = tf.random.uniform([2*self.batch_num, 1, 1], -433.0127+55.0, -433.0127+55.0)
                fixed_y52 = tf.random.uniform([2 * self.batch_num, 1, 1], 250.0+95.26, 250.0+95.26)
                fixed_z52 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser52 = tf.concat([fixed_x52, fixed_y52, fixed_z52], axis=2)
                fixed_x53 = tf.random.uniform([2*self.batch_num, 1, 1], -433.0127+55.0, -433.0127+55.0)
                fixed_y53 = tf.random.uniform([2 * self.batch_num, 1, 1], 250.0-95.26, 250.0-95.26)
                ...
                fixed_x61 = tf.random.uniform([2*self.batch_num, 1, 1], -433.0127-110.0, -433.0127-110.0)
                fixed_y61 = tf.random.uniform([2 * self.batch_num, 1, 1], 750.0, 750.0)
                fixed_z61 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser61 = tf.concat([fixed_x61, fixed_y61, fixed_z61], axis=2)
                fixed_x62 = tf.random.uniform([2*self.batch_num, 1, 1], -433.0127+55.0, -433.0127+55.0)
                fixed_y62 = tf.random.uniform([2 * self.batch_num, 1, 1], 750.0+95.26, 750.0+95.26)
                fixed_z62 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser62 = tf.concat([fixed_x62, fixed_y62, fixed_z62], axis=2)
                fixed_x63 = tf.random.uniform([2*self.batch_num, 1, 1], -433.0127+55.0, -433.0127+55.0)
                fixed_y63 = tf.random.uniform([2 * self.batch_num, 1, 1], 750.0-95.26, 750.0-95.26)
                ...
                fixed_x71 = tf.random.uniform([2*self.batch_num, 1, 1],  0.0-110.0,  0.0-110.0)
                fixed_y71 = tf.random.uniform([2 * self.batch_num, 1, 1], -1000.0, -1000.0)
                fixed_z71 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser71 = tf.concat([fixed_x71, fixed_y71, fixed_z71], axis=2)
                fixed_x72 = tf.random.uniform([2*self.batch_num, 1, 1],  0.0+55.0,  0.0+55.0)
                fixed_y72 = tf.random.uniform([2 * self.batch_num, 1, 1], -1000.0+95.26, -1000.0+95.26)
                fixed_z72 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser72 = tf.concat([fixed_x72, fixed_y72, fixed_z72], axis=2)
                fixed_x73 = tf.random.uniform([2*self.batch_num, 1, 1],  0.0+55.0,  0.0+55.0)
                fixed_y73 = tf.random.uniform([2 * self.batch_num, 1, 1], -1000.0-95.26, -1000.0-95.26)
                ...
                fixed_x81 = tf.random.uniform([2*self.batch_num, 1, 1],  0.0-110.0,  0.0-110.0)
                fixed_y81 = tf.random.uniform([2 * self.batch_num, 1, 1], -500.0, -500.0)
                fixed_z81 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser81 = tf.concat([fixed_x81, fixed_y81, fixed_z81], axis=2)
                fixed_x82 = tf.random.uniform([2*self.batch_num, 1, 1],  0.0+55.0,  0.0+55.0)
                fixed_y82 = tf.random.uniform([2 * self.batch_num, 1, 1], -500.0+95.26, -500.0+95.26)
                fixed_z82 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser82 = tf.concat([fixed_x82, fixed_y82, fixed_z82], axis=2)
                fixed_x83 = tf.random.uniform([2*self.batch_num, 1, 1],  0.0+55.0,  0.0+55.0)
                fixed_y83 = tf.random.uniform([2 * self.batch_num, 1, 1], -500.0-95.26, -500.0-95.26)
                ...
                fixed_x91 = tf.random.uniform([2*self.batch_num, 1, 1],  0.0-110.0,  0.0-110.0)
                fixed_y91 = tf.random.uniform([2 * self.batch_num, 1, 1], 0.0, 0.0)
                fixed_z91 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser91 = tf.concat([fixed_x91, fixed_y91, fixed_z91], axis=2)
                fixed_x92 = tf.random.uniform([2*self.batch_num, 1, 1],  0.0+55.0,  0.0+55.0)
                fixed_y92 = tf.random.uniform([2 * self.batch_num, 1, 1], 0.0+95.26, 0.0+95.26)
                fixed_z92 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser92 = tf.concat([fixed_x92, fixed_y92, fixed_z92], axis=2)
                fixed_x93 = tf.random.uniform([2*self.batch_num, 1, 1],  0.0+55.0,  0.0+55.0)
                fixed_y93 = tf.random.uniform([2 * self.batch_num, 1, 1], 0.0-95.26, 0.0-95.26)
                ...
                fixed_x101 = tf.random.uniform([2*self.batch_num, 1, 1],  0.0-110.0,  0.0-110.0)
                fixed_y101 = tf.random.uniform([2 * self.batch_num, 1, 1], 500.0, 500.0)
                fixed_z101 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser101 = tf.concat([fixed_x101, fixed_y101, fixed_z101], axis=2)
                fixed_x102 = tf.random.uniform([2*self.batch_num, 1, 1],  0.0+55.0,  0.0+55.0)
                fixed_y102 = tf.random.uniform([2 * self.batch_num, 1, 1], 500.0+95.26, 500.0+95.26)
                fixed_z102 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser102 = tf.concat([fixed_x102, fixed_y102, fixed_z102], axis=2)
                fixed_x103 = tf.random.uniform([2*self.batch_num, 1, 1],  0.0+55.0,  0.0+55.0)
                fixed_y103 = tf.random.uniform([2 * self.batch_num, 1, 1], 500.0-95.26, 500.0-95.26)
                ...
                fixed_x111 = tf.random.uniform([2*self.batch_num, 1, 1],  0.0-110.0,  0.0-110.0)
                fixed_y111 = tf.random.uniform([2 * self.batch_num, 1, 1], 1000.0, 1000.0)
                fixed_z111 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser111 = tf.concat([fixed_x111, fixed_y111, fixed_z111], axis=2)
                fixed_x112 = tf.random.uniform([2*self.batch_num, 1, 1],  0.0+55.0,  0.0+55.0)
                fixed_y112 = tf.random.uniform([2 * self.batch_num, 1, 1], 1000.0+95.26, 1000.0+95.26)
                fixed_z112 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser112 = tf.concat([fixed_x112, fixed_y112, fixed_z112], axis=2)
                fixed_x113 = tf.random.uniform([2*self.batch_num, 1, 1],  0.0+55.0,  0.0+55.0)
                fixed_y113 = tf.random.uniform([2 * self.batch_num, 1, 1], 1000.0-95.26, 1000.0-95.26)
                ...
                fixed_x121 = tf.random.uniform([2*self.batch_num, 1, 1],  433.0127-110.0,  433.0127-110.0)
                fixed_y121 = tf.random.uniform([2 * self.batch_num, 1, 1], -750.0, -750.0)
                fixed_z121 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser121 = tf.concat([fixed_x121, fixed_y121, fixed_z121], axis=2)
                fixed_x122 = tf.random.uniform([2*self.batch_num, 1, 1],  433.0127+55.0,  433.0127+55.0)
                fixed_y122 = tf.random.uniform([2 * self.batch_num, 1, 1], -750.0+95.26, -750.0+95.26)
                fixed_z122 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser122 = tf.concat([fixed_x122, fixed_y122, fixed_z122], axis=2)
                fixed_x123 = tf.random.uniform([2*self.batch_num, 1, 1],  433.0127+55.0,  433.0127+55.0)
                fixed_y123 = tf.random.uniform([2 * self.batch_num, 1, 1], -750.0-95.26, -750.0-95.26)
                ...
                fixed_x131 = tf.random.uniform([2*self.batch_num, 1, 1],  433.0127-110.0,  433.0127-110.0)
                fixed_y131 = tf.random.uniform([2 * self.batch_num, 1, 1], -250.0, -250.0)
                fixed_z131 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser131 = tf.concat([fixed_x131, fixed_y131, fixed_z131], axis=2)
                fixed_x132 = tf.random.uniform([2*self.batch_num, 1, 1],  433.0127+55.0,  433.0127+55.0)
                fixed_y132 = tf.random.uniform([2 * self.batch_num, 1, 1], -250.0+95.26, -250.0+95.26)
                fixed_z132 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser132 = tf.concat([fixed_x132, fixed_y132, fixed_z132], axis=2)
                fixed_x133 = tf.random.uniform([2*self.batch_num, 1, 1],  433.0127+55.0,  433.0127+55.0)
                fixed_y133 = tf.random.uniform([2 * self.batch_num, 1, 1], -250.0-95.26, -250.0-95.26)
                ...
                fixed_x141 = tf.random.uniform([2*self.batch_num, 1, 1],  433.0127-110.0,  433.0127-110.0)
                fixed_y141 = tf.random.uniform([2 * self.batch_num, 1, 1], 250.0, 250.0)
                fixed_z141 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser141 = tf.concat([fixed_x141, fixed_y141, fixed_z141], axis=2)
                fixed_x142 = tf.random.uniform([2*self.batch_num, 1, 1],  433.0127+55.0,  433.0127+55.0)
                fixed_y142 = tf.random.uniform([2 * self.batch_num, 1, 1], 250.0+95.26, 250.0+95.26)
                fixed_z142 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser142 = tf.concat([fixed_x142, fixed_y142, fixed_z142], axis=2)
                fixed_x143 = tf.random.uniform([2*self.batch_num, 1, 1],  433.0127+55.0,  433.0127+55.0)
                fixed_y143 = tf.random.uniform([2 * self.batch_num, 1, 1], 250.0-95.26, 250.0-95.26)
                ...
                fixed_x151 = tf.random.uniform([2*self.batch_num, 1, 1],  433.0127-110.0,  433.0127-110.0)
                fixed_y151 = tf.random.uniform([2 * self.batch_num, 1, 1], 750.0, 750.0)
                fixed_z151 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser151 = tf.concat([fixed_x151, fixed_y151, fixed_z151], axis=2)
                fixed_x152 = tf.random.uniform([2*self.batch_num, 1, 1],  433.0127+55.0,  433.0127+55.0)
                fixed_y152 = tf.random.uniform([2 * self.batch_num, 1, 1], 750.0+95.26, 750.0+95.26)
                fixed_z152 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser152 = tf.concat([fixed_x152, fixed_y152, fixed_z152], axis=2)
                fixed_x153 = tf.random.uniform([2*self.batch_num, 1, 1],  433.0127+55.0,  433.0127+55.0)
                fixed_y153 = tf.random.uniform([2 * self.batch_num, 1, 1], 750.0-95.26, 750.0-95.26)
                ...
                fixed_x161 = tf.random.uniform([2*self.batch_num, 1, 1],  866.0254-110.0,  866.0254-110.0)
                fixed_y161 = tf.random.uniform([2 * self.batch_num, 1, 1], -500.0, -500.0)
                fixed_z161 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser161 = tf.concat([fixed_x161, fixed_y161, fixed_z161], axis=2)
                fixed_x162 = tf.random.uniform([2*self.batch_num, 1, 1],  866.0254+55.0,  866.0254+55.0)
                fixed_y162 = tf.random.uniform([2 * self.batch_num, 1, 1], -500.0+95.26, -500.0+95.26)
                fixed_z162 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser162 = tf.concat([fixed_x162, fixed_y162, fixed_z162], axis=2)
                fixed_x163 = tf.random.uniform([2*self.batch_num, 1, 1],  866.0254+55.0,  866.0254+55.0)
                fixed_y163 = tf.random.uniform([2 * self.batch_num, 1, 1], -500.0-95.26, -500.0-95.26)
                ...
                fixed_x171 = tf.random.uniform([2*self.batch_num, 1, 1],  866.0254-110.0,  866.0254-110.0)
                fixed_y171 = tf.random.uniform([2 * self.batch_num, 1, 1], 0.0, 0.0)
                fixed_z171 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser171 = tf.concat([fixed_x171, fixed_y171, fixed_z171], axis=2)
                fixed_x172 = tf.random.uniform([2*self.batch_num, 1, 1],  866.0254+55.0,  866.0254+55.0)
                fixed_y172 = tf.random.uniform([2 * self.batch_num, 1, 1], 0.0+95.26, 0.0+95.26)
                fixed_z172 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser172 = tf.concat([fixed_x172, fixed_y172, fixed_z172], axis=2)
                fixed_x173 = tf.random.uniform([2*self.batch_num, 1, 1],  866.0254+55.0,  866.0254+55.0)
                fixed_y173 = tf.random.uniform([2 * self.batch_num, 1, 1], 0.0-95.26, 0.0-95.26)
                ...
                fixed_x181 = tf.random.uniform([2*self.batch_num, 1, 1],  866.0254-110.0,  866.0254-110.0)
                fixed_y181 = tf.random.uniform([2 * self.batch_num, 1, 1], 500.0, 500.0)
                fixed_z181 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser181 = tf.concat([fixed_x181, fixed_y181, fixed_z181], axis=2)
                fixed_x182 = tf.random.uniform([2*self.batch_num, 1, 1],  866.0254+55.0,  866.0254+55.0)
                fixed_y182 = tf.random.uniform([2 * self.batch_num, 1, 1], 500.0+95.26, 500.0+95.26)
                fixed_z182 = tf.random.uniform([2 * self.batch_num, 1, 1], 1.5, 1.5)
                Xuser182 = tf.concat([fixed_x182, fixed_y182, fixed_z182], axis=2)
                fixed_x183 = tf.random.uniform([2*self.batch_num, 1, 1],  866.0254+55.0,  866.0254+55.0)
                fixed_y183 = tf.random.uniform([2 * self.batch_num, 1, 1], 500.0-95.26, 500.0-95.26)
